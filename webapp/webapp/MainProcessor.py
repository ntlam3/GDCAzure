...
def eupromo(s):
    ...
    s16_ap03_mem=s.get(URL.s16_ap03_mem_url)
    ...
    s17_ap06_cpu=s.get(URL.s17_ap06_cpu_url)
    s17_ap06_mem=s.get(URL.s17_ap06_mem_url)
    s18_ap07_cpu=s.get(URL.s18_ap07_cpu_url)
    s18_ap07_mem=s.get(URL.s18_ap07_mem_url)
    s19_bi01_cpu=s.get(URL.s19_bi01_cpu_url)
    s19_bi01_mem=s.get(URL.s19_bi01_mem_url)
    s19_build01_cpu=s.get(URL.s19_build01_cpu_url)
    s19_build01_mem=s.get(URL.s19_build01_mem_url)
    s20_dia01_cpu=s.get(URL.s20_dia01_cpu_url)
    s20_dia01_mem=s.get(URL.s20_dia01_mem_url)
    s20_acr01_cpu=s.get(URL.s20_acr01_cpu_url)
    s20_acr01_mem=s.get(URL.s20_acr01_mem_url)
    ...
    f.close()
    f=open(folder_eupromo + '//s15_ap02_cpu.jpg','wb')
    f.write(s15_ap02_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s15_ap02_mem.jpg','wb')
    f.write(s15_ap02_mem.content)
    f.close()
    ...
    f.write(s17_ap05_mem.content)
    f.close()
    f=open(folder_eupromo + '//s17_ap06_cpu.jpg','wb')
    f.write(s17_ap06_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s17_ap06_mem.jpg','wb')
    f.write(s17_ap06_mem.content)
    f.close()
    f=open(folder_eupromo + '//s18_ap07_cpu.jpg','wb')
    f.write(s18_ap07_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s18_ap07_mem.jpg','wb')
    f.write(s18_ap07_mem.content)
    f.close()
    f=open(folder_eupromo + '//s19_bi01_cpu.jpg','wb')
    f.write(s19_bi01_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s19_bi01_mem.jpg','wb')
    f.write(s19_bi01_mem.content)
    f.close()
    f=open(folder_eupromo + '//s19_build01_cpu.jpg','wb')
    f.write(s19_build01_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s19_build01_mem.jpg','wb')
    f.write(s19_build01_mem.content)
    f.close()
    f=open(folder_eupromo + '//s20_dia01_cpu.jpg','wb')
    f.write(s20_dia01_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s20_dia01_mem.jpg','wb')
    f.write(s20_dia01_mem.content)
    f.close()
    f=open(folder_eupromo + '//s20_acr01_cpu.jpg','wb')
    f.write(s20_acr01_cpu.content)
    f.close()
    f=open(folder_eupromo + '//s20_acr01_mem.jpg','wb')
    f.write(s20_acr01_mem.content)
    f.close()
    return eupromo_src
#------------------KCDM----------------------
def KCDM(s):
...
def kcdm_dynamic(s):
    print('------------------KCDM Dynamic----------------------')
    date_time=datetime.datetime.now()
    kcdm_dynamic_src="Zabbix_images-KCDM-Dynamic" + '-' + date_time.strftime('%y') + '-' + date_time.strftime('%m') + '-' + date_time.strftime('%d')
    folder_KCDM_dynamic="//var//www//webapp//webapp//static//"+kcdm_dynamic_src
    if (os.path.isdir(folder_KCDM_dynamic)):
        pass
    else:
        os.umask(0)
        os.mkdir(folder_KCDM_dynamic,0o777)
